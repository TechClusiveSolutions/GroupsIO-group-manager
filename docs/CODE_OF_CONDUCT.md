...
Given that this project is built by and for a blindness-focused nonprofit, we hold accessibility and respectful, non-visual-first communication as a core value of this community, not an afterthought.
...
* Focusing on what is best for the community and the mission BITS serves.

Examples of unacceptable behavior:

* Harassment, insults, or derogatory comments, public or private.
* Trolling, or deliberately inflammatory or off-topic contributions.
